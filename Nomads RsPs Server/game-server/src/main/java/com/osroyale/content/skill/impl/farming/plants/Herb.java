...
public enum Herb implements Plant {
    GUAM(5291, 199, 9, 1, 11, 12.5, 4, 8),
    MARRENTILL(5292, 201, 14, 1, 13.5, 15, 11, 15),
    TARROMIN(5293, 203, 19, 1,  16, 18, 18, 22),
    HARRALANDER(5294, 205, 26, 1,  21.5, 24, 25, 29),
    GOUT_TUBER(6311, 3261, 29, 1, 105, 45, 192, 196),
    RANARR(5295, 207, 32, 1,  27, 30.5, 32, 36),
    TOADFLAX(5296, 3049, 38, 1, 34, 38.5, 39, 43),
    IRIT(5297, 209, 44, 1, 43, 48.5, 46, 50),
    AVANTOE(5298, 211, 50, 1,  54.5, 61.5, 53, 57),
    KUARM(5299, 213, 56, 1, 69, 78, 0x44, 72),
    SNAPDRAGON(5300, 3051, 62, 1,  87.5, 98.5, 75, 79),
    CADANTINE(5301, 215, 67, 1,  106.5, 120, 82, 86),
    LANTADYME(5302, 2485, 73, 1,  134.5, 151.5, 89, 93),
    DWARF(5303, 217, 79, 1, 170.5, 192, 96, 100),
    TORSOL(5304, 219, 85, 1,  199.5, 224.5, 103, 107);
